        ...
        <div className="flex h-screen bg-gray-100 ">
            ...
            <aside className="w-64 bg-white shadow-lg">
                <div className="px-6 py-8">
                    <h2 className="text-2xl font-bold text-emerald-600">Goods Supplier Dashboard</h2>
                </div>
                <nav className="mt-10">
                    <ul>
                        <li>
                            <NavLink
                                to={`/goods-supplier-dashboard/${userId}/add`}
                                className={({ isActive }) =>
                                    isActive ? 'flex items-center px-4 py-2 bg-emerald-200' : 'flex items-center px-4 py-2 hover:bg-gray-200'
                                }
                            >
                                <FaPlus className="mr-3" />
                                Add Scope3 Goods and Services Supplied Data
                            </NavLink>
                        </li>
            ...
            <div className="flex-1 p-8">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <span className="text-lg text-gray-700">Goods Supplier Profile</span>
                    </div>
                </div>
...
export default GoodsSupplierDashboard;